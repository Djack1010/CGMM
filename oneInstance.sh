...
python3 TestTemplateSup.py -l $2 -e 20 -al 4 -nl $3 -tdp ./data/folder_$1/train/ -vdp ./data/folder_$1/valid/ -ff f$1 2>> $SCRIPTPATH/logsRun/errors$1 1>> $SCRIPTPATH/logsRun/log$1
